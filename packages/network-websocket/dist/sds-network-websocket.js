...
var R = (n, e, t) => B(n, typeof e != "symbol" ? e + "" : e, t), P = (n, e, t) => e.has(n) || N("Cannot " + t);
var s = (n, e, t) => (P(n, e, "read from private field"), t ? t.call(n) : e.get(n)), h = (n, e, t) => e.has(n) ? N("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(n) : e.set(n, t), S = (n, e, t, i) => (P(n, e, "write to private field"), i ? i.call(n, t) : e.set(n, t), t), a = (n, e, t) => (P(n, e, "access private method"), t);
function V(...n) {
...
var d, l, b, A, u, g, H, U, M, w, L, c, Z, y, I, v, D, K;
class x {
  /**** constructor ****/
  constructor(e) {
    h(this, c);
  ...
  disconnect() {
    var e;
    a(this, c, D).call(this), a(this, c, I).call(this, "disconnected"), (e = s(this, l)) == null || e.close(), S(this, l, void 0);
  }
  /**** sendPatch ****/
  sendPatch(e) {
...
Z = function() {
  return new Promise((e, t) => {
    ...
    o.binaryType = "arraybuffer", S(this, l, o), a(this, c, I).call(this, "connecting"), o.onopen = () => {
      ...
      S(this, l, void 0), s(this, d) !== "disconnected" && (a(this, c, I).call(this, "reconnecting"), a(this, c, v).call(this));
    }, o.onmessage = (r) => {
  ...
  switch (t) {
    ...
    case 5: {
      ...
      if (f == null && (f = { total: k, chunks: /* @__PURE__ */ new Map() }, s(this, w).set(o, f)), f.chunks.set(_, E), f.chunks.size === f.total) {
        const W = V(
          ...Array.from({ length: f.total }, (G, p) => f.chunks.get(p))
        );
        s(this, w).delete(o);
