...
var Q = (n, e, s) => Y(n, typeof e != "symbol" ? e + "" : e, s), U = (n, e, s) => e.has(n) || E("Cannot " + s);
var t = (n, e, s) => (U(n, e, "read from private field"), s ? s.call(n) : e.get(n)), h = (n, e, s) => e.has(n) ? E("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(n) : e.set(n, s), r = (n, e, s, i) => (U(n, e, "write to private field"), i ? i.call(n, s) : e.set(n, s), s), l = (n, e, s) => (U(n, e, "access private method"), s);
var q = (n, e, s, i) => ({
  set _(c) {
    r(n, e, c, s);
  },
...
import { SDS_Error as D } from "@rozek/sds-core";
const Z = 512 * 1024;
var u, d, a, w, k, B, _, N, S, L, P, b, m, C, T, p, g, v, R, M, y, o, I, j, $, z, F, V, G, J, K, W, x;
class et {
  //----------------------------------------------------------------------------//
  //                                Constructor                                 //
  //----------------------------------------------------------------------------//
  ...
  async stop() {
    ...
    r(this, y, []), (e = t(this, v)) == null || e.close(), r(this, v, void 0), (s = t(this, a)) == null || s.disconnect(), t(this, d) != null && t(this, S) > 0 && await l(this, o, V).call(this), await ((i = t(this, d)) == null ? void 0 : i.close());
  }
  //----------------------------------------------------------------------------//
  //                             Network Connection                             //
  //----------------------------------------------------------------------------//
  ...
  async connectTo(e, s) {
    if (t(this, a) == null)
      throw new D("no-network-provider", "no NetworkProvider configured");
    r(this, B, e), r(this, _, s), await t(this, a).connect(e, s);
  }
  /**** disconnect ****/
  disconnect() {
    if (t(this, a) == null)
  ...
  async reconnect() {
    ...
    await t(this, a).connect(t(this, B), t(this, _));
  }
  /**** ConnectionState ****/
  get ConnectionState() {
    return t(this, R);
...
u = new WeakMap(), d = new WeakMap(), a = new WeakMap(), w = new WeakMap(), k = new WeakMap(), B = new WeakMap(), _ = new WeakMap(), N = new WeakMap(), S = new WeakMap(), L = new WeakMap(), P = new WeakMap(), b = new WeakMap(), m = new WeakMap(), C = new WeakMap(), T = new WeakMap(), p = new WeakMap(), g = new WeakMap(), v = new WeakMap(), R = new WeakMap(), M = new WeakMap(), y = new WeakMap(), o = new WeakSet(), I = async function() {
  if (t(this, d) == null)
    return;
...
j = function() {
  const e = t(this, u).onChangeInvoke((s, i) => {
    ...
    }), r(this, S, t(this, S) + f.byteLength), t(this, S) >= Z && l(this, o, V).call(this).catch(() => {
    })), ((H = t(this, a)) == null ? void 0 : H.ConnectionState) === "connected" ? (t(this, a).sendPatch(f), (A = t(this, v)) == null || A.postMessage({ type: "patch", payload: f })) : t(this, N).push(f), l(this, o, J).call(this, i).catch(() => {
    }));
  });
  t(this, y).push(e);
...
$ = function() {
  if (t(this, a) != null) {
    ...
    const i = t(this, a).onValue(async (c, f) => {
      var H;
      await ((H = t(this, d)) == null ? void 0 : H.saveValue(c, f));
    });
    t(this, y).push(i);
  }
  const e = t(this, w);
